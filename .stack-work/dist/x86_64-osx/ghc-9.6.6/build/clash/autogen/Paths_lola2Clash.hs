...
libdir     = "/Users/boli/university/thesis/Lola2Clash/.stack-work/install/x86_64-osx/2ddffa28b1fbace304f4c52a11858e248f5e84ba5279964fc4ce81040525d7e0/9.6.6/lib/x86_64-osx-ghc-9.6.6/lola2Clash-0.1-8nhWJFKBqECC28eB2gmJRU-clash"
...
getDynLibDir  = catchIO (getEnv "lola2Clash_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "lola2Clash_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "lola2Clash_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "lola2Clash_sysconfdir") (\_ -> return sysconfdir)
