...
-- output b := a + e.offset(by: -1).defaults(to: 0) 
-- output c := x + b
...
nullPacings = Pacings nullPacingIn0 nullPacingOut0 nullPacingOut1 nullPacingOut2 nullPacingOut3 nullPacingOut4 
...
hlc inputs = out
    where 
        ...
        pacings = Pacings <$> pIn0 <*> pOut0 <*> pOut1 <*> pOut2 <*> pOut3 <*> pOut4
...
llc event = bundle (toPop, outputs)
    where 
        ...
        curTags = Tags <$> tIn0 <*> tOut0 <*> tOut1 <*> tOut2 <*> tOut3 <*> tOut4
        ...
        out1Data1 = getOffsetFromNonVec <$> out4 <*> ((.output4) <$> curTagsLevel2) <*> (pure 1) <*> out1Data1Dflt
        out1Data1Dflt = pure (0)

        -- Evaluation of output 2: level 3
        out2 = outputStream2 enOut2 ((.output2) <$> curTagsLevel3) out2Data0 out2Data1 
        out2Data0 = getMatchingTagFromNonVec <$> input0Win <*> ((.input0) <$> curTagsLevel3) <*> (pure (0))
        out2Data1 = getMatchingTagFromNonVec <$> out1 <*> ((.output1) <$> curTagsLevel3) <*> (pure (0))
