...
module topEntity
  ...
  wire [134:0] result_6;
  // sliding_window_and_event_based.hs:143:1-89
  wire  newX;
  // sliding_window_and_event_based.hs:143:1-89
  wire  timer1Over;
  // sliding_window_and_event_based.hs:143:1-89
  wire  timer2Over;
  wire [455:0] result_7;
  // sliding_window_and_event_based.hs:231:1-116
  wire  eta;
  // sliding_window_and_event_based.hs:231:1-116
  ...
  // sliding_window_and_event_based.hs:181:1-158
  wire  pacingBC;
  wire  result_9;
  // sliding_window_and_event_based.hs:181:1-158
  wire  pacingA;
  ...
  wire  result_11;
  // sliding_window_and_event_based.hs:248:1-140
  wire signed [63:0] y;
  // sliding_window_and_event_based.hs:248:1-140
  wire signed [63:0] x2;
  // sliding_window_and_event_based.hs:248:1-140
  ...
  wire [64:0] hasDataX;
  wire  result_14;
  // sliding_window_and_event_based.hs:179:24-25
  wire signed [63:0] \a# ;
  // sliding_window_and_event_based.hs:181:1-158
  ...
  // sliding_window_and_event_based.hs:181:1-158
  wire [69:0] c$eventInfo_app_arg;
  // sliding_window_and_event_based.hs:181:1-158
  reg [69:0] eventInfo = {{64'sd0,   1'b0},   {1'b0,   1'b0},   {1'b0,   1'b0,   1'b0}};
  wire [71:0] result_15;
  reg [69:0] c$app_arg = {{64'sd0,   1'b0},   {1'b0,   1'b0},   {1'b0,   1'b0,   1'b0}};
  wire [69:0] c$case_alt;
  reg [69:0] c$case_alt_0;
  ...
  wire  c$case_alt_4;
  // sliding_window_and_event_based.hs:74:1-78
  reg [419:0] buffer = {{{64'sd0,   1'b0},   {1'b0,   1'b0},   {1'b0,   1'b0,   1'b0}},   {{64'sd0,
                                                                     1'b0},
                                                                    {1'b0,
                                                                     1'b0},
                                                                    {1'b0,
 ...
 {{64'sd0,   1'b0},   {1'b0,   1'b0},   {1'b0,   1'b0,   1'b0}},   {{64'sd0,
                                                                    ...
                                                                    {1'b0,
                                                                     ...
                                                                     1'b0}}};
  // sliding_window_and_event_based.hs:74:1-78
  wire [419:0] c$buffer_case_alt;
  // sliding_window_and_event_based.hs:74:1-78
  wire [419:0] c$buffer_case_alt_0;
  // sliding_window_and_event_based.hs:74:1-78
  wire [69:0] qData;
  // sliding_window_and_event_based.hs:74:1-78
  ...
  // sliding_window_and_event_based.hs:272:1-178
  wire  qPopValid;
  // sliding_window_and_event_based.hs:272:1-178
  wire  qPush;
  // sliding_window_and_event_based.hs:272:1-178
  ...
  wire [489:0] c$buffer_case_alt_sel_alt_t_1;
  ...
  assign result_6 = {{newX | (timer1Over | (newX | timer1Over)),
                      {input0,   {timer1Over,   timer2Over},
                       {newX,   timer1Over,   timer2Over}}},
                     result_5};
  ...
  assign timer2Over = result_3 >= (64'sd2000000);

  assign result_7 = {result_11,
                     {{(x1 * 64'sd10),   result_10 & pacingA},
                      {out,   result_10 & pacingBC}},   {state,
                                                         window,   x_1,   pacingA,   pacingBC,
                                                         slideBC}};

  assign eta = result_9 & pacingBC;
  ...
  assign c$case_alt_7 = (x_6 + y_2);





  assign result_8 = eta ? t : out;

  assign pacingBC = eventInfo[1:1];

  assign c$tte_rhs = (\a#  == 64'sd2) ? 64'sd1 : 64'sd0;

  assign result_9 = c$tte_rhs[0];

  assign pacingA = eventInfo[2:2];

  assign c$tte_rhs_0 = (\a#  == 64'sd3) ? 64'sd1 : 64'sd0;

  assign result_10 = c$tte_rhs_0[0];

  assign x1 = x_1;

  assign x_1 = $signed(hasDataX[64:1]);

  assign c$tte_rhs_1 = (\a#  == 64'sd0) ? 64'sd1 : 64'sd0;

  assign result_11 = c$tte_rhs_1[0];
  ...
  assign result_12 = result_14 ? result_13 : window;

  assign result_13 = slideBC ? c$t_case_alt : c$t_case_alt_0;
  ...
  assign slideBC = eventInfo[4:4];

  assign hasDataX = eventInfo[69:5];

  assign c$tte_rhs_2 = (\a#  == 64'sd1) ? 64'sd1 : 64'sd0;

  assign result_14 = c$tte_rhs_2[0];
  ...
  assign c$eventInfo_app_arg = qPopValid ? result_15[69:0] : eventInfo;

  // register begin
  always @(posedge clk or  posedge  rst) begin : eventInfo_register
    if ( rst) begin
      eventInfo <= {{64'sd0,   1'b0},   {1'b0,   1'b0},   {1'b0,   1'b0,   1'b0}};
    end else if (en) begin
  ...
  assign result_15 = {c$app_arg_1,   c$app_arg_0,
                      c$app_arg};

  // register begin
  always @(posedge clk or  posedge  rst) begin : c$app_arg_register
    if ( rst) begin
      c$app_arg <= {{64'sd0,   1'b0},   {1'b0,   1'b0},   {1'b0,   1'b0,   1'b0}};
    end else if (en) begin
  ...
  // index begin
  wire [69:0] vecArray [0:6-1];
  genvar i_0;
  generate
  for (i_0=0; i_0 < 6; i_0=i_0+1) begin : mk_array
    assign vecArray[(6-1)-i_0] = buffer[i_0*70+:70];
  end
  endgenerate
  ...
  assign c$buffer_case_alt_0 = c$cursor_case_scrut ? c$buffer_case_alt_sel_alt_t_1[489:70] : buffer;

  assign qData = result_6[133:64];
  ...
  assign c$cursor_case_alt_2 = c$cursor_case_scrut ? ((x_2 + 64'sd1)) : cursor;

  assign c$tte_rhs_3 = (x_2 != 64'sd6) ? 64'sd1 : 64'sd0;
  ...
  assign c$cursor_case_alt_5 = (x_2 - 64'sd1);

  assign result = {result_7[454:325],
                   {$signed(result_6[63:0]),   result_7[324:323],
                    result_7[322:67],   qPush,   qPop,
                    result_15[71:71],   qPopValid,
                    $signed(result_7[66:3]),   result_7[2:2],
                    result_7[1:1],   result_7[0:0]}};

  assign qPopValid = result_15[70:70];

  assign qPush = result_6[134:134];

  assign qPop = result_7[455:455];
