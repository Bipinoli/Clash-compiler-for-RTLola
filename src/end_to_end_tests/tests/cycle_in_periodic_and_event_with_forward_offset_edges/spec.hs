...
-- 
-- output a := x + 1
-- output b := a.offset(by: -1).defaults(to: 0) + d.offset(by: -1).defaults(to: 1) + h.hold(or: 0)
-- output c := b + o + 1
-- output d := c + 1
-- output e := f.offset(by: -1).defaults(to: 0) + i.offset(by: -1).defaults(to: 0)
-- output f := g + 1
-- output g @1kHz := g.offset(by: -1).defaults(to: 0) + 1
-- output h @1kHz := e + d.hold(or: 0)
-- output i := h + 1   
-- 
-- output m := y + 1
-- output n := m.offset(by: -1).defaults(to: 0) +1
-- output o := n + 1
...
data PacingOut9 = PacingOut9 PacingIn1 deriving (Generic, NFDataX)
data PacingOut10 = PacingOut10 PacingIn1 deriving (Generic, NFDataX)
data PacingOut11 = PacingOut11 PacingIn1 deriving (Generic, NFDataX)
...
nullPacingOut9 = PacingOut9 nullPacingIn1 
nullPacingOut10 = PacingOut10 nullPacingIn1 
nullPacingOut11 = PacingOut11 nullPacingIn1 
...
hlc inputs = out
    where 
        ...
        pOut7 = PacingOut7 <$> timer0Over
        pOut8 = PacingOut8 <$> timer0Over
        pOut9 = PacingOut9 <$> pIn1
        pOut10 = PacingOut10 <$> pIn1
        pOut11 = PacingOut11 <$> pIn1
...
llc event = bundle (bundle (toPop, outputs), debugSignals)
    where 
        ...
        tagsDefault = Tags nullT nullT nullT nullT nullT nullT nullT nullT nullT nullT nullT nullT nullT nullT 
        curTags = Tags <$> tIn0 <*> tIn1 <*> tOut0 <*> tOut1 <*> tOut2 <*> tOut3 <*> tOut4 <*> tOut5 <*> tOut6 <*> tOut7 <*> tOut8 <*> tOut9 <*> tOut10 <*> tOut11
        ...
        enOut9 = delayFor d2 nullPacingOut9 pOut9
        ...
        enOut7 = delayFor d5 nullPacingOut7 pOut7
        enOut8 = delayFor d6 nullPacingOut8 pOut8
        ...
        output8Aktv = delayFor d7 False (getPacing <$> pOut8)
        output9Aktv = delayFor d7 False (getPacing <$> pOut9)
        output10Aktv = delayFor d7 False (getPacing <$> pOut10)
        output11Aktv = delayFor d7 False (getPacing <$> pOut11)
        ...
        out1 = outputStream1 enOut1 ((.output1) <$> curTagsLevel1) out1Data0 out1Data1 out1Data2 
        out1Data0 = getOffset <$> out0 <*> ((.output0) <$> curTagsLevel1) <*> (pure 1) <*> out1Data0Dflt
        out1Data0Dflt = pure (0)
        out1Data1 = getOffsetFromNonVec <$> out3 <*> ((.output3) <$> curTagsLevel1) <*> (pure 1) <*> out1Data1Dflt
        out1Data1Dflt = pure (1)
        out1Data2 = getLatestValueFromNonVec <$> out7 <*> out1Data2Dflt
        out1Data2Dflt = pure (0)

        -- Evaluation of output 2: level 2
        out2 = outputStream2 enOut2 ((.output2) <$> curTagsLevel2) out2Data0 out2Data1 
        out2Data0 = getMatchingTag <$> out1 <*> ((.output1) <$> curTagsLevel2) <*> (pure (0))
        out2Data1 = getMatchingTag <$> out11 <*> ((.output11) <$> curTagsLevel2) <*> (pure (0))

        -- Evaluation of output 3: level 3
        out3 = outputStream3 enOut3 ((.output3) <$> curTagsLevel3) out3Data0 
        out3Data0 = getMatchingTag <$> out2 <*> ((.output2) <$> curTagsLevel3) <*> (pure (0))

        -- Evaluation of output 4: level 3
        out4 = outputStream4 enOut4 ((.output4) <$> curTagsLevel3) out4Data0 out4Data1 
        out4Data0 = getOffsetFromNonVec <$> out5 <*> ((.output5) <$> curTagsLevel3) <*> (pure 1) <*> out4Data0Dflt
        out4Data0Dflt = pure (0)
        out4Data1 = getOffsetFromNonVec <$> out8 <*> ((.output8) <$> curTagsLevel3) <*> (pure 1) <*> out4Data1Dflt
        out4Data1Dflt = pure (0)

        -- Evaluation of output 5: level 4
        out5 = outputStream5 enOut5 ((.output5) <$> curTagsLevel4) out5Data0 
        out5Data0 = getMatchingTagFromNonVec <$> out6 <*> ((.output6) <$> curTagsLevel4) <*> (pure (0))

        -- Evaluation of output 6: level 3
        out6 = outputStream6 enOut6 ((.output6) <$> curTagsLevel3) out6Data0 
        out6Data0 = getOffsetFromNonVec <$> out6 <*> ((.output6) <$> curTagsLevel3) <*> (pure 1) <*> out6Data0Dflt
        out6Data0Dflt = pure (0)

        -- Evaluation of output 7: level 4
        out7 = outputStream7 enOut7 ((.output7) <$> curTagsLevel4) out7Data0 out7Data1 
        out7Data0 = getLatestValueFromNonVec <$> out3 <*> out7Data0Dflt
        out7Data0Dflt = pure (0)
        out7Data1 = getMatchingTagFromNonVec <$> out4 <*> ((.output4) <$> curTagsLevel4) <*> (pure (0))

        -- Evaluation of output 8: level 5
        out8 = outputStream8 enOut8 ((.output8) <$> curTagsLevel5) out8Data0 
        out8Data0 = getMatchingTagFromNonVec <$> out7 <*> ((.output7) <$> curTagsLevel5) <*> (pure (0))

        -- Evaluation of output 9: level 1
        out9 = outputStream9 enOut9 ((.output9) <$> curTagsLevel1) out9Data0 
        out9Data0 = getMatchingTagFromNonVec <$> input1Win <*> ((.input1) <$> curTagsLevel1) <*> (pure (0))

        -- Evaluation of output 10: level 0
        out10 = outputStream10 enOut10 tOut10 out10Data0 
        out10Data0 = getOffset <$> out9 <*> tOut9 <*> (pure 1) <*> out10Data0Dflt
        out10Data0Dflt = pure (0)

        -- Evaluation of output 11: level 1
        out11 = outputStream11 enOut11 ((.output11) <$> curTagsLevel1) out11Data0 
        out11Data0 = getMatchingTag <$> out10 <*> ((.output10) <$> curTagsLevel1) <*> (pure (0))
        ...
        output9Data = getMatchingTag <$> out9 <*> ((.output9) <$> curTagsLevel6) <*> (pure 0)
        output10 = ValidInt <$> output10Data <*> output10Aktv
        output10Data = getMatchingTag <$> out10 <*> ((.output10) <$> curTagsLevel6) <*> (pure 0)
        output11 = ValidInt <$> output11Data <*> output11Aktv
        output11Data = getMatchingTag <$> out11 <*> ((.output11) <$> curTagsLevel6) <*> (pure 0)
...
outputStream0 :: HiddenClockResetEnable dom => Signal dom PacingOut0 -> Signal dom Tag -> Signal dom Int -> Signal dom (Vec 2 (Tag, Int))
...
outputStream1 :: HiddenClockResetEnable dom => Signal dom PacingOut1 -> Signal dom Tag -> Signal dom Int -> Signal dom Int -> Signal dom Int -> Signal dom (Vec 2 (Tag, Int))
outputStream1 en tag out0 out3 out7 = result
    where
        result = register (repeat (invalidTag, 0)) (mux (getPacing <$> en) next result)
        next = (<<+) <$> result <*> nextValWithTag
        nextValWithTag = bundle (tag, nextVal)
        nextVal = out0 + out3 + out7


outputStream2 :: HiddenClockResetEnable dom => Signal dom PacingOut2 -> Signal dom Tag -> Signal dom Int -> Signal dom Int -> Signal dom (Vec 2 (Tag, Int))
outputStream2 en tag out1 out11 = result
    where
        result = register (repeat (invalidTag, 0)) (mux (getPacing <$> en) next result)
        next = (<<+) <$> result <*> nextValWithTag
        nextValWithTag = bundle (tag, nextVal)
        nextVal = out1 + out11 + 1
...
outputStream4 en tag out5 out8 = result
    where
        result = register (invalidTag, 0) (mux (getPacing <$> en) nextValWithTag result)
        nextValWithTag = bundle (tag, nextVal)
        nextVal = out5 + out8
...
outputStream5 en tag out6 = result
    where
        result = register (invalidTag, 0) (mux (getPacing <$> en) nextValWithTag result)
        nextValWithTag = bundle (tag, nextVal)
        nextVal = out6 + 1
...
outputStream6 en tag out6 = result
    where
        result = register (invalidTag, 0) (mux (getPacing <$> en) nextValWithTag result)
        nextValWithTag = bundle (tag, nextVal)
        nextVal = out6 + 1
...
outputStream7 en tag out3 out4 = result
    where
        result = register (invalidTag, 0) (mux (getPacing <$> en) nextValWithTag result)
        nextValWithTag = bundle (tag, nextVal)
        nextVal = out4 + out3
...
outputStream8 en tag out7 = result
    where
        result = register (invalidTag, 0) (mux (getPacing <$> en) nextValWithTag result)
        nextValWithTag = bundle (tag, nextVal)
        nextVal = out7 + 1
...
outputStream9 :: HiddenClockResetEnable dom => Signal dom PacingOut9 -> Signal dom Tag -> Signal dom Int -> Signal dom (Vec 2 (Tag, Int))
outputStream9 en tag in1 = result
    where
        result = register (repeat (invalidTag, 0)) (mux (getPacing <$> en) next result)
        next = (<<+) <$> result <*> nextValWithTag
        nextValWithTag = bundle (tag, nextVal)
...
outputStream10 :: HiddenClockResetEnable dom => Signal dom PacingOut10 -> Signal dom Tag -> Signal dom Int -> Signal dom (Vec 2 (Tag, Int))
outputStream10 en tag out9 = result
    where
        result = register (repeat (invalidTag, 0)) (mux (getPacing <$> en) next result)
        next = (<<+) <$> result <*> nextValWithTag
        nextValWithTag = bundle (tag, nextVal)
...
outputStream11 en tag out10 = result
    where
        result = register (repeat (invalidTag, 0)) (mux (getPacing <$> en) next result)
        next = (<<+) <$> result <*> nextValWithTag
        nextValWithTag = bundle (tag, nextVal)
