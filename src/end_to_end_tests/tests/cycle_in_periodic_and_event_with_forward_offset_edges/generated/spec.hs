...
llc event = bundle (bundle (toPop, outputs), debugSignals)
    where 
        ...
        enOut6 = delayFor d5 nullPacingOut6 pOut6
        ...
        out4 = outputStream4 enOut4 ((.output4) <$> curTagsLevel4) out4Data0 out4Data1 
        out4Data0 = getOffsetFromNonVec <$> out5 <*> ((.output5) <$> curTagsLevel4) <*> (pure 1) <*> out4Data0Dflt
        out4Data0Dflt = pure (0)
        out4Data1 = getOffsetFromNonVec <$> out8 <*> ((.output8) <$> curTagsLevel4) <*> (pure 1) <*> out4Data1Dflt
        out4Data1Dflt = pure (0)

        -- Evaluation of output 5: level 5
        out5 = outputStream5 enOut5 ((.output5) <$> curTagsLevel5) out5Data0 
        out5Data0 = getMatchingTagFromNonVec <$> out6 <*> ((.output6) <$> curTagsLevel5) <*> (pure (0))

        -- Evaluation of output 6: level 4
        out6 = outputStream6 enOut6 ((.output6) <$> curTagsLevel4) out6Data0 
        out6Data0 = getOffsetFromNonVec <$> out6 <*> ((.output6) <$> curTagsLevel4) <*> (pure 1) <*> out6Data0Dflt
        out6Data0Dflt = pure (0)

        -- Evaluation of output 7: level 5
        out7 = outputStream7 enOut7 ((.output7) <$> curTagsLevel5) out7Data0 out7Data1 
        out7Data0 = getMatchingTagFromNonVec <$> out4 <*> ((.output4) <$> curTagsLevel5) <*> (pure (0))
        out7Data1 = getLatestValueFromNonVec <$> out3 <*> out7Data1Dflt
        out7Data1Dflt = pure (0)

        -- Evaluation of output 8: level 6
        out8 = outputStream8 enOut8 ((.output8) <$> curTagsLevel6) out8Data0 
        out8Data0 = getMatchingTagFromNonVec <$> out7 <*> ((.output7) <$> curTagsLevel6) <*> (pure (0))
        ...
        output1Data = getMatchingTag <$> out1 <*> ((.output1) <$> curTagsLevel7) <*> (pure 0)
        ...
        output10Data = getMatchingTag <$> out10 <*> ((.output10) <$> curTagsLevel7) <*> (pure 0)
...
pipelineReady rst = toWait .==. pure 0 
    where 
        waitTime = pure 5 :: Signal dom Int
