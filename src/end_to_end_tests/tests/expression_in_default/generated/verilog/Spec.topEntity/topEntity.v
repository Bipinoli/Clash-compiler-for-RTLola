...
module topEntity
  ...
  // spec.hs:306:1-119
  reg [215:0] result_7 = {{8'd3,   64'sd0},   {8'd3,   64'sd0},   {8'd3,   64'sd0}};
  // spec.hs:306:1-119
  wire [215:0] t_1;
  wire [215:0] result_8;
  // spec.hs:210:1-121
  ...
  // spec.hs:311:1-119
  reg [215:0] result_9 = {{8'd3,   64'sd0},   {8'd3,   64'sd0},   {8'd3,   64'sd0}};
  // spec.hs:311:1-119
  wire [215:0] t_2;
  wire [215:0] result_10;
  // spec.hs:296:9-81
  reg [7:0] t_3 = 8'd1;
  wire [7:0] result_11;
  // spec.hs:296:9-81
  ...
  wire [7:0] result_18;
  // spec.hs:210:1-121
  reg [47:0] c$ds3_app_arg = {8'd3,   8'd3,   8'd3,   8'd3,   8'd3,   8'd3};
  // spec.hs:210:1-121
  reg [47:0] c$ds3_app_arg_0 = {8'd3,   8'd3,   8'd3,   8'd3,   8'd3,   8'd3};
  // spec.hs:210:1-121
  reg [47:0] c$ds3_case_scrut = {8'd3,   8'd3,   8'd3,   8'd3,   8'd3,   8'd3};
  // spec.hs:210:1-121
  reg [47:0] c$ds4_app_arg = {8'd3,   8'd3,   8'd3,   8'd3,   8'd3,   8'd3};
  // spec.hs:210:1-121
  ...
  // spec.hs:317:1-120
  reg [143:0] result_22 = {{8'd3,   64'sd0},   {8'd3,   64'sd0}};
  // spec.hs:317:1-120
  wire [143:0] t_7;
  // spec.hs:210:1-121
  ...
  // spec.hs:337:1-120
  reg [143:0] result_33 = {{8'd3,   64'sd0},   {8'd3,   64'sd0}};
  // spec.hs:337:1-120
  wire [143:0] t_9;
  // spec.hs:193:1-70
 ...
 {{{64'sd0,   1'b0},   {64'sd0,   1'b0}},   {1'b0,   1'b0,   1'b0,   1'b0}}};
  ...
  assign result_2 = {pacing3 | (pacing3 | (hasInput1 | pacing3)),
  ...
  always @(posedge clk or  posedge  rst) begin : result_7_register
    if ( rst) begin
      result_7 <= {{8'd3,   64'sd0},   {8'd3,   64'sd0},   {8'd3,   64'sd0}};
    end else if (en) begin
      result_7 <= result_8;
    end
  end
  ...
  always @(posedge clk or  posedge  rst) begin : result_9_register
    if ( rst) begin
      result_9 <= {{8'd3,   64'sd0},   {8'd3,   64'sd0},   {8'd3,   64'sd0}};
    end else if (en) begin
      result_9 <= result_10;
    end
  end
  ...
  assign t_2 = t_projection_2[215:0];
  ...
  // delay begin
  always @(posedge clk) begin : c$ds3_app_arg_0_delay
    if (en) begin
      c$ds3_app_arg_0 <= c$ds3_app_arg;
    end
  end
  // delay end
  ...
  always @(posedge clk) begin : c$ds3_case_scrut_delay
    if (en) begin
      c$ds3_case_scrut <= c$ds3_app_arg_0;
    end
  end
  // delay end

  // delay begin
  always @(posedge clk) begin : c$ds4_app_arg_delay
    if (en) begin
      c$ds4_app_arg <= c$ds3_case_scrut;
    end
  end
  // delay end
  ...
  always @(posedge clk) begin : c$ds4_case_scrut_delay
    if (en) begin
      c$ds4_case_scrut <= c$ds4_app_arg;
    end
  end
  // delay end
  ...
  for (i_6 = 0; i_6 < 3; i_6 = i_6 + 1) begin : zipWith
    ...
    assign zipWith_in1 = result_7[i_6*72+:72];
  ...
  for (i_7=0; i_7 < 3; i_7 = i_7 + 1) begin : imap
    ...
    assign c$case_alt_13 = (t_11 == result_20) ? {1'b1,map_index} : map_in[2:0];

    assign t_11 = x_2[71:64];
  ...
  for (i_8=0; i_8 < 3; i_8=i_8+1) begin : mk_array
    assign vecArray[(3-1)-i_8] = result_7[i_8*72+:72];
  end
  endgenerate
  ...
  assign result_19 = c$case_scrut_0[2:2] ? {c$ds3_app_arg_0[47:40],
                                            $signed(c$case_scrut[63:0])} : {c$ds3_app_arg_0[47:40],
                                                                            64'sd2000};

  assign result_20 = (c$ds3_app_arg_0[47:40] > 8'd1) ? c$app_arg : (c$app_arg + 8'd2);

  assign c$app_arg = c$ds3_app_arg_0[47:40] - 8'd1;

  assign i = c$case_scrut_0[1:0];

  assign ws = {c$ws_app_arg_0,{1'b0,2'bxx}};

  assign result_21 = c$out0_app_arg_1 ? t_7 : result_22;

  // register begin
  always @(posedge clk or  posedge  rst) begin : result_22_register
    if ( rst) begin
      result_22 <= {{8'd3,   64'sd0},   {8'd3,   64'sd0}};
    end else if (en) begin
      result_22 <= result_21;
    end
  end
  ...
  assign t_projection_4 = ({result_22,{result_19[71:64],   $signed(result_19[63:0])}});

  assign t_7 = t_projection_4[143:0];
  ...
  for (i_10 = 0; i_10 < 3; i_10 = i_10 + 1) begin : zipWith_0
    ...
    assign zipWith_in1_0 = result_9[i_10*72+:72];
  ...
  for (i_11=0; i_11 < 3; i_11 = i_11 + 1) begin : imap_0
    ...
    assign c$case_alt_14 = (t_12 == result_24) ? {1'b1,map_index_0} : map_in_0[2:0];

    assign t_12 = x_3[71:64];
  ...
  for (i_12=0; i_12 < 3; i_12=i_12+1) begin : mk_array_0
    assign vecArray_0[(3-1)-i_12] = result_9[i_12*72+:72];
  end
  endgenerate
  ...
  assign result_23 = c$case_scrut_2[2:2] ? {out1Level3TagIn1,
                                            $signed(c$case_scrut_1[63:0])} : {out1Level3TagIn1,
                                                                              64'sd1000};

  assign result_24 = (out1Level3TagIn1 > 8'd1) ? c$app_arg_0 : (c$app_arg_0 + 8'd2);

  assign c$app_arg_0 = out1Level3TagIn1 - 8'd1;
  ...
  genvar i_13;
  generate
  for (i_13 = 0; i_13 < 2; i_13 = i_13 + 1) begin : zipWith_1
    wire [71:0] zipWith_in1_1;
    assign zipWith_in1_1 = result_22[i_13*72+:72];
    wire [1:0] zipWith_in2_1;
    assign zipWith_in2_1 = c$vec2_1[i_13*2+:2];
    wire [73:0] c$n_1;
    assign c$n_1 = {zipWith_in1_1,   zipWith_in2_1};


    assign c$ws_app_arg_3[i_13*74+:74] = c$n_1;
  end
  endgenerate
  // zipWith end
  ...
  genvar i_14;
  generate
  for (i_14=0; i_14 < 2; i_14 = i_14 + 1) begin : imap_1
    wire [1-1:0] map_index_1;
    wire [73:0] map_in_1;
    assign map_in_1 = c$ws_app_arg_3[i_14*74+:74];
    wire [1:0] map_out_1;

    assign map_index_1 = 1'd1 - i_14[0+:1];
    ...
    assign c$case_alt_15 = (t_13 == result_26) ? {1'b1,map_index_1} : map_in_1[1:0];

    assign t_13 = x_4[71:64];

    assign x_4 = map_in_1[73:2];


    assign c$ws_app_arg_4[i_14*2+:2] = map_out_1;
  end
  endgenerate
  // imap end
  ...
  genvar i_15;
  generate
  for (i_15=0; i_15 < 2; i_15=i_15+1) begin : mk_array_1
    assign vecArray_1[(2-1)-i_15] = result_22[i_15*72+:72];
  end
  endgenerate
  ...
  assign result_25 = c$case_scrut_4[1:1] ? {out1Level3TagOut0,
                                            $signed(c$case_scrut_3[63:0])} : {out1Level3TagOut0,
                                                                              64'sd2000};

  assign result_26 = (out1Level3TagOut0 > 8'd1) ? c$app_arg_1 : (c$app_arg_1 + 8'd2);

  assign c$app_arg_1 = out1Level3TagOut0 - 8'd1;

  assign i_1 = c$case_scrut_4[0:0];

  assign ws_1 = {c$ws_app_arg_4,{1'b0,1'bx}};

  assign result_27 = c$out1_app_arg_2 ? t_8 : result_28;
  ...
  assign t_8 = {result_23[71:64],   (x + y)};

  assign x = $signed(result_25[63:0]);

  assign y = $signed(result_23[63:0]);
  ...
  for (i_16 = 0; i_16 < 2; i_16 = i_16 + 1) begin : zipWith_2
    ...
    assign zipWith_in1_2 = result_22[i_16*72+:72];
  ...
  for (i_17=0; i_17 < 2; i_17 = i_17 + 1) begin : imap_2
    ...
    assign c$case_alt_16 = (t_14 == level5TagOut0) ? {1'b1,map_index_2} : map_in_2[1:0];

    assign t_14 = x_6[71:64];
  ...
  for (i_18=0; i_18 < 2; i_18=i_18+1) begin : mk_array_2
    assign vecArray_2[(2-1)-i_18] = result_22[i_18*72+:72];
  end
  endgenerate
  ...
  assign result_29 = c$case_scrut_6[1:1] ? {level5TagOut0,
  ...
  for (i_19 = 0; i_19 < 3; i_19 = i_19 + 1) begin : zipWith_3
    ...
    assign zipWith_in1_3 = result_9[i_19*72+:72];
  ...
  for (i_20=0; i_20 < 3; i_20 = i_20 + 1) begin : imap_3
    ...
    assign c$case_alt_17 = (t_15 == result_31) ? {1'b1,map_index_3} : map_in_3[2:0];

    assign t_15 = x_7[71:64];

    assign x_7 = map_in_3[74:3];
  ...
  for (i_21=0; i_21 < 3; i_21=i_21+1) begin : mk_array_3
    assign vecArray_3[(3-1)-i_21] = result_9[i_21*72+:72];
  end
  endgenerate
  ...
  assign result_30 = c$case_scrut_8[2:2] ? {c$ds3_app_arg[39:32],
                                            $signed(c$case_scrut_7[63:0])} : {c$ds3_app_arg[39:32],
                                                                              64'sd2000};

  assign result_31 = (c$ds3_app_arg[39:32] > 8'd1) ? c$app_arg_9 : (c$app_arg_9 + 8'd2);

  assign c$app_arg_9 = c$ds3_app_arg[39:32] - 8'd1;

  assign i_3 = c$case_scrut_8[1:0];

  assign ws_3 = {c$ws_app_arg_8,{1'b0,2'bxx}};

  assign result_32 = c$app_arg_8 ? t_9 : result_33;

  // register begin
  always @(posedge clk or  posedge  rst) begin : result_33_register
    if ( rst) begin
      result_33 <= {{8'd3,   64'sd0},   {8'd3,   64'sd0}};
    end else if (en) begin
      result_33 <= result_32;
    end
  end
  ...
  assign t_projection_9 = ({result_33,{result_30[71:64],   $signed(result_30[63:0])}});

  assign t_9 = t_projection_9[143:0];
  ...
  for (i_22 = 0; i_22 < 2; i_22 = i_22 + 1) begin : zipWith_4
    ...
    assign zipWith_in1_4 = result_33[i_22*72+:72];
  ...
  for (i_23=0; i_23 < 2; i_23 = i_23 + 1) begin : imap_4
    ...
    assign c$case_alt_18 = (t_16 == level5TagOut2) ? {1'b1,map_index_4} : map_in_4[1:0];

    assign t_16 = x_8[71:64];

    assign x_8 = map_in_4[73:2];
  ...
  for (i_24=0; i_24 < 2; i_24=i_24+1) begin : mk_array_4
    assign vecArray_4[(2-1)-i_24] = result_33[i_24*72+:72];
  end
  endgenerate
  ...
  assign result_34 = c$case_scrut_10[1:1] ? {level5TagOut2,
                                             $signed(c$case_scrut_9[63:0])} : {level5TagOut2,
                                                                               64'sd0};
  ...
  for (i_25 = 0; i_25 < 3; i_25 = i_25 + 1) begin : zipWith_5
    ...
    assign zipWith_in1_5 = result_7[i_25*72+:72];
  ...
  for (i_26=0; i_26 < 3; i_26 = i_26 + 1) begin : imap_5
    ...
    assign c$case_alt_19 = (t_17 == result_36) ? {1'b1,map_index_5} : map_in_5[2:0];

    assign t_17 = x_9[71:64];

    assign x_9 = map_in_5[74:3];
  ...
  for (i_27=0; i_27 < 3; i_27=i_27+1) begin : mk_array_5
    assign vecArray_5[(3-1)-i_27] = result_7[i_27*72+:72];
  end
  endgenerate
  ...
  assign result_35 = c$case_scrut_12[2:2] ? {c$ds4_app_arg[47:40],
                                             $signed(c$case_scrut_11[63:0])} : {c$ds4_app_arg[47:40],
                                                                                64'sd2000};

  assign result_36 = (c$ds4_app_arg[47:40] > 8'd1) ? c$app_arg_19 : (c$app_arg_19 + 8'd2);

  assign c$app_arg_19 = c$ds4_app_arg[47:40] - 8'd1;

  assign i_5 = c$case_scrut_12[1:0];

  assign ws_5 = {c$ws_app_arg_12,{1'b0,2'bxx}};

  assign result_37 = c$app_arg_18 ? t_10 : result_38;
  ...
  assign t_10 = {result_35[71:64],   (x_0 + y_0)};

  assign x_0 = $signed(result_35[63:0]);

  assign y_0 = $signed(result_28[63:0]);

  // delay begin
  always @(posedge clk) begin : c$app_arg_20_delay
    if (en) begin
      c$app_arg_20 <= c$app_arg_18;
    end
  end
  // delay end

  assign result_39 = {{1'b1,
                       {{$signed(result_29[63:0]),   c$app_arg_4},
                        {$signed(result_28[63:0]),   c$app_arg_6},
                        {$signed(result_34[63:0]),   c$app_arg_13},
                        {$signed(result_38[63:0]),   c$app_arg_20}}},
                      pacings};

  assign pacings = result_40[3:0];

  assign input0 = result_40[133:69];
  ...
  assign input2 = result_40[68:4];

  assign out1Level3TagIn1 = c$ds3_case_scrut[39:32];

  assign out1Level3TagOut0 = c$ds3_case_scrut[31:24];

  assign level5TagOut0 = c$ds4_case_scrut[31:24];

  assign level5TagOut2 = c$ds4_case_scrut[15:8];
  ...
  genvar i_28;
  generate
  for (i_28=0; i_28 < 2; i_28=i_28+1) begin : mk_array_6
    assign vecArray_6[(2-1)-i_28] = buffer[i_28*134+:134];
  end
  endgenerate
  ...
  assign result = {result_39[263:4],   {qPush,
                                        qPop,   result_40[135:135],   qPopValid,
                                        result_39[3:0]}};

  assign qPopValid = result_40[134:134];

  assign qPush = result_2[134:134];

  assign qPop = result_39[264:264];
