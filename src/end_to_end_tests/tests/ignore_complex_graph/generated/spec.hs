...
hlc inputs = out
    where 
        ...
        newEvent = hasInput0 .||. pacing0 .||. pacing1 .||. pacing2 .||. pacing3 .||. pacing4 .||. pacing5 .||. pacing6 .||. pacing7 .||. pacing8 .||. pacing9 .||. pacing10 .||. pacing11 .||. pacing12 .||. pacing13
...
llc event = bundle (toPop, outputs)
    where 
        ...
        out1Data1 = getMatchingTagFromNonVec <$> out0 <*> out1Level2TagOut0 <*> (pure 0)
        ...
        out4Data0 = getMatchingTagFromNonVec <$> out3 <*> out4Level2TagOut3 <*> (pure 0)
        ...
        out5Data0 = getMatchingTagFromNonVec <$> out3 <*> out5Level2TagOut3 <*> (pure 0)
        ...
        out9Data0 = getOffsetFromNonVec <$> out9 <*> tagOut9 <*> (pure 1) <*> out9Data0Dflt
        ...
        out10Data0 = getMatchingTagFromNonVec <$> out9 <*> out10Level1TagOut9 <*> (pure 0)
        ...
        out11Data0 = getMatchingTagFromNonVec <$> out10 <*> out11Level2TagOut10 <*> (pure 0)
...
outputStream9 :: HiddenClockResetEnable dom => Signal dom Bool -> Signal dom Tag -> Signal dom (Tag, Int) -> Signal dom (Tag, Int)
...
outputStream10 :: HiddenClockResetEnable dom => Signal dom Bool -> Signal dom Tag -> Signal dom (Tag, Int) -> Signal dom (Tag, Int) -> Signal dom (Tag, Int)
