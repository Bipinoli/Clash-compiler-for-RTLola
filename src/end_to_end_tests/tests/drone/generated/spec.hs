...
-- Evaluation Order
--------------------
-- lat_gps, acceleration_x, gps_sats
...
-- acceleration_x_changes, sw(lat_gps,gps_medium_loss), sw(lat_gps,gps_medium_loss), sw(lat_gps,gps_missed_beat), sw(lat_gps,gps_high_loss), sw(lat_gps,gps_high_loss), sw(lat_gps,gps_very_high_loss)
-- trigger_acc, gps_medium_loss, gps_missed_beat, gps_high_loss, gps_very_high_loss, trigger_gps_sats
...
-- lat_gps,acceleration_x,gps_sats                                                                                                                                                               | lat_gps,acceleration_x,gps_sats                                                                                                                                                               | lat_gps,acceleration_x,gps_sats                                                                                                                                                               | lat_gps,acceleration_x,gps_sats                                                                                                                                                               | lat_gps,acceleration_x,gps_sats                                                                                                                                                               | lat_gps,acceleration_x,gps_sats                                                                                                                                                               | lat_gps,acceleration_x,gps_sats                                                                                                                                                               | lat_gps,acceleration_x,gps_sats                                                                                                                                                               | lat_gps,acceleration_x,gps_sats                                                                                                                                                               | lat_gps,acceleration_x,gps_sats                                                                                                                                                              
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--                                                                                                                                                                                               |                                                                                                                                                                                               |                                                                                                                                                                                               |                                                                                                                                                                                               |                                                                                                                                                                                               | acceleration_x_changes,sw(lat_gps,gps_medium_loss),sw(lat_gps,gps_medium_loss),sw(lat_gps,gps_missed_beat),sw(lat_gps,gps_high_loss),sw(lat_gps,gps_high_loss),sw(lat_gps,gps_very_high_loss) | acceleration_x_changes,sw(lat_gps,gps_medium_loss),sw(lat_gps,gps_medium_loss),sw(lat_gps,gps_missed_beat),sw(lat_gps,gps_high_loss),sw(lat_gps,gps_high_loss),sw(lat_gps,gps_very_high_loss) | acceleration_x_changes,sw(lat_gps,gps_medium_loss),sw(lat_gps,gps_medium_loss),sw(lat_gps,gps_missed_beat),sw(lat_gps,gps_high_loss),sw(lat_gps,gps_high_loss),sw(lat_gps,gps_very_high_loss) | acceleration_x_changes,sw(lat_gps,gps_medium_loss),sw(lat_gps,gps_medium_loss),sw(lat_gps,gps_missed_beat),sw(lat_gps,gps_high_loss),sw(lat_gps,gps_high_loss),sw(lat_gps,gps_very_high_loss) | acceleration_x_changes,sw(lat_gps,gps_medium_loss),sw(lat_gps,gps_medium_loss),sw(lat_gps,gps_missed_beat),sw(lat_gps,gps_high_loss),sw(lat_gps,gps_high_loss),sw(lat_gps,gps_very_high_loss)
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--                                                                                                                                                                                               |                                                                                                                                                                                               |                                                                                                                                                                                               |                                                                                                                                                                                               |                                                                                                                                                                                               |                                                                                                                                                                                               | trigger_acc,gps_medium_loss,gps_missed_beat,gps_high_loss,gps_very_high_loss,trigger_gps_sats                                                                                                 | trigger_acc,gps_medium_loss,gps_missed_beat,gps_high_loss,gps_very_high_loss,trigger_gps_sats                                                                                                 | trigger_acc,gps_medium_loss,gps_missed_beat,gps_high_loss,gps_very_high_loss,trigger_gps_sats                                                                                                 | trigger_acc,gps_medium_loss,gps_missed_beat,gps_high_loss,gps_very_high_loss,trigger_gps_sats                                                                                                
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
