...
hlc inputs = out
    where 
        ...
        newEvent = hasInput0 .||. pacing0 .||. pacing1 .||. pacing2 .||. pacing3 .||. pacing4 .||. pacing5 .||. pacing6 .||. pacing7 .||. pacing8 .||. pacing9
...
llc event = bundle (toPop, outputs)
    where 
        ...
        out8Data0 = getMatchingTagFromNonVec <$> out6 <*> out8Level1TagOut6 <*> (pure 0)
        ...
        out9Data0 = getMatchingTagFromNonVec <$> out8 <*> out9Level2TagOut8 <*> (pure 0)
...
outputStream0 :: HiddenClockResetEnable dom => Signal dom Bool -> Signal dom Tag -> Signal dom (Tag, Int) -> Signal dom (Tag, Int)
