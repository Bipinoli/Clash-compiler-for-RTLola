...
llc event = bundle (bundle (toPop, outputs), debugSignals)
    where 
        ...
        out1 = outputStream1 enOut1 
            ...
            out1Data1 
            out1Data2 
        out1Data0 = getLatestValueFromNonVec 
            <$> out0 
            <*> out1Data0Dflt
        out1Data0Dflt = pure (0)
        out1Data1 = getOffset         
            <$> out5 
            <*> ((.output5) <$> curTagsLevel1) 
            <*> (pure 1) 
            <*> out1Data1Dflt
        ...
        out2 = outputStream2 enOut2 
            ...
            out2Data0 
            out2Data1 
        out2Data0 = getOffsetFromNonVec 
            <$> out1 
            <*> ((.output1) <$> curTagsLevel1) 
            <*> (pure 1) 
            <*> out2Data0Dflt
        out2Data0Dflt = pure (0)
        out2Data1 = getLatestValueFromNonVec 
            <$> out3 
            <*> out2Data1Dflt
        ...
        out4 = outputStream4 enOut4 
            ...
            out4Data0 
        out4Data0 = getLatestValueFromNonVec 
            <$> out2 
            <*> out4Data0Dflt
        ...
        out5 = outputStream5 enOut5 
            ((.output5) <$> curTagsLevel1) 
            out5Data0 
        out5Data0 = getLatestValueFromNonVec 
            <$> out3 
            <*> out5Data0Dflt
