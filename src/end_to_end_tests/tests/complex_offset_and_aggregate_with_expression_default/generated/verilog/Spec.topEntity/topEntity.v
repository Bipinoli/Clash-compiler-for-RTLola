...
module topEntity
 ...
 8'd6,   8'd6};
  ...
  reg [95:0] c$app_arg_22 = {8'd6,   8'd6,   8'd6,   8'd6,   8'd6,   8'd6,   8'd6,   8'd6,   8'd6,   8'd6,
 8'd6,   8'd6};
 ...
 {{{64'sd0,   1'b0},   {64'sd0,   1'b0}},   {1'b0,   1'b0},   {1'b0,   1'b0,
  ...
  assign result_2 = {hasInput0 | (hasInput1 | (timer1Over | timer1Over)),
  ...
  assign result_35 = (t_2 > 8'd1) ? c$app_arg_0 : (c$app_arg_0 + 8'd5);

  assign c$app_arg_0 = t_2 - 8'd1;
  ...
  assign result_39 = (out0Level1TagIn0 > 8'd2) ? c$app_arg_1 : (c$app_arg_1 + 8'd5);
  ...
  assign result_49 = (out0Level1TagIn0 > 8'd1) ? c$app_arg_2 : (c$app_arg_2 + 8'd5);
  ...
  assign result_50 = (out0Level1TagOut3 > 8'd1) ? c$app_arg_3 : (c$app_arg_3 + 8'd5);
  ...
  assign result_56 = (out3Level3TagOut3 > 8'd1) ? c$app_arg_4 : (c$app_arg_4 + 8'd5);

  assign c$app_arg_4 = out3Level3TagOut3 - 8'd1;
  ...
  assign result_61 = c$app_arg_37 ? t_17 : result_62;
  ...
  assign result_63 = c$app_arg_50 ? t_18 : window_0;

  assign t_18 = {curTagsLevel4[7:0],   result_64};

  assign result_64 = c$app_arg_54 ? c$t_case_alt_2 : c$t_case_alt_3;

  assign c$t_case_alt_sel_alt_t_3 = ({win_0,wild2_0});

  assign c$t_case_alt_sel_alt_f_3 = ({win_0,64'sd0});

  assign c$t_case_alt_2 = c$app_arg_19 ? c$t_case_alt_sel_alt_t_3[255:0] : c$t_case_alt_sel_alt_f_3[255:0];

  assign wild2_0 = $signed(result_58[63:0]);

  assign c$t_case_alt_3 = c$app_arg_19 ? c$t_case_alt_4 : win_0;
  ...
  assign result_65 = c$app_arg_45 ? t_19 : result_66;
  ...
  assign t_19 = {c$app_arg_22[23:16],
                 c$t_app_arg_0};

  // delay begin
  always @(posedge clk) begin : c$app_arg_55_delay
    if (en) begin
      c$app_arg_55 <= c$app_arg_45;
    end
  end
  // delay end

  assign result_67 = {{result_7 & (~ result_10),
                       {{dta,   c$app_arg_9},   {dta_0,
                                                 c$app_arg_14},   {dta_1,   c$app_arg_18},
                        {$signed(result_58[63:0]),   c$app_arg_21},
                        {$signed(result_59[63:0]),   c$app_arg_28},
                        {$signed(result_46[63:0]),   c$app_arg_32},
                        {$signed(result_62[63:0]),   c$app_arg_39},
