...
llc event = bundle (bundle (toPop, outputs), debugSignals)
    where 
        ...
        out2Data1 = getMatchingTag 
            ...
            <*> (pure (0))
        out2Data2 = getMatchingTag 
            <$> input0Win 
            <*> ((.input0) <$> curTagsLevel2) 
            <*> (pure (0))
        out2Data3 = getMatchingTagFromNonVec 
            <$> input1Win 
            <*> ((.input1) <$> curTagsLevel2) 
            <*> (pure (0))
        ...
        out6Data1 = getMatchingTagFromNonVec 
            ...
            <*> (pure (0))
        out6Data2 = getLatestValueFromNonVec 
            <$> out3 
            <*> out6Data2Dflt
